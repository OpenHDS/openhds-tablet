...
public class ExtraFormUpdate implements Updatable {
    ...
    public void updateDatabase(ContentResolver resolver, String filepath,String jrFormId) {
         ...
         try {
             Form form = xmlReader.readForm(new FileInputStream(new File(filepath)), jrFormId);
             ...
             ContentValues cv = new ContentValues();
	            ...
	            Cursor cursor  = resolver.query(OpenHDS.Individuals.CONTENT_ID_URI_BASE,
	                    ...
	                    new String[] { form.getIndExtId() }, null);
             ...
             Log.e(ExtraFormUpdate.class.getName(), "Could not read extraForm XML file");
         }
     }
    }
